namespace PVT.Q1._2017.Shop.Areas.Admin.Controllers
{
    ...
    /// </summary>
    [Authorize]
    public partial class TrackControllerAdv : Controller
    {
        #region Fields
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackControllerAdv"/> class.
        /// </summary>
        /// <param name="trackService">
        /// The track service.
        /// </param>
        /// <param name="repositoryFactory">The repository factory.</param>
        public TrackControllerAdv(IService<Track> trackService, IFactory repositoryFactory)
        {
