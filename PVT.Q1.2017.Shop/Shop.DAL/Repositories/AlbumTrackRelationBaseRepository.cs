namespace Shop.DAL.Repositories
{
    ...
    /// </summary>
    public class AlbumTrackRelationBaseRepository : BaseRepository<AlbumTrackRelation>, IAlbumTrackRelationRepository
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AlbumTrackRelationBaseRepository"/> class.
        /// </summary>
        /// <param name="dbContext">
        /// The db context.
        /// </param>
        public AlbumTrackRelationBaseRepository(DbContext dbContext) : base(dbContext)
        {
        }
